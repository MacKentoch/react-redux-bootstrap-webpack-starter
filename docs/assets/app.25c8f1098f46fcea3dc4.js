...
var ScrollToTop_1 = __importDefault(__webpack_require__(/*! ./components/scrollToTop/ScrollToTop */ "./src/front/components/scrollToTop/ScrollToTop.js"));
var MainLayout_1 = __importDefault(__webpack_require__(/*! ./layout/MainLayout */ "./src/front/layout/MainLayout/index.js"));
var MainRoutes_1 = __importDefault(__webpack_require__(/*! ./routes/MainRoutes */ "./src/front/routes/MainRoutes.js"));
var routes_1 = __webpack_require__(/*! ./routes/routes */ "./src/front/routes/routes.js");
var userAuthActions = __importStar(__webpack_require__(/*! ./redux/modules/userAuth */ "./src/front/redux/modules/userAuth/index.js"));
...
var Root = (function (_super) {
    ...
    Root.prototype.render = function () {
        return (React.createElement(react_redux_1.Provider, { store: store },
            React.createElement(styled_components_1.ThemeProvider, { theme: {} },
                React.createElement(React.Fragment, null,
                    React.createElement(connected_react_router_1.ConnectedRouter, { history: configureStore_2.history },
                        React.createElement(ScrollToTop_1.default, null,
                            React.createElement(react_router_dom_1.Switch, null,
                                React.createElement(MainLayout_1.default, null,
                                    React.createElement(MainRoutes_1.default, null)),
                                React.createElement(react_router_dom_1.Route, { path: "*", component: routes_1.PageNotFound })))),
...
/* harmony import */ var _Root__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Root */ "./src/front/Root.tsx");
/* harmony import */ var _Root__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_Root__WEBPACK_IMPORTED_MODULE_7__);
...
renderApp(_Root__WEBPACK_IMPORTED_MODULE_7___default.a); // $FlowIgnore
...
/***/ "./src/front/redux/store/configureStore.dev.ts":
/*!*****************************************************!*\
  !*** ./src/front/redux/store/configureStore.dev.ts ***!
  \*****************************************************/
/*! no static exports found */
...
var reducers_1 = __importDefault(__webpack_require__(/*! ../modules/reducers */ "./src/front/redux/modules/reducers.js"));
var fetchMiddleware_1 = __importDefault(__webpack_require__(/*! ../middleware/fetchMiddleware */ "./src/front/redux/middleware/fetchMiddleware.js"));
exports.history = history_1.createBrowserHistory();
var loggerMiddleware = redux_logger_1.createLogger({
    level: 'info',
    collapsed: true,
});
var enhancer = redux_devtools_extension_1.composeWithDevTools(redux_1.applyMiddleware(redux_thunk_1.default, connected_react_router_1.routerMiddleware(exports.history), fetchMiddleware_1.default, loggerMiddleware));
var persistConfig = {
    key: 'root',
...
if (false) {}
    ...
    configureStore = __webpack_require__(/*! ./configureStore.dev */ "./src/front/redux/store/configureStore.dev.ts").default;
}
exports.default = configureStore;
...
/******/ });
//# sourceMappingURL=app.25c8f1098f46fcea3dc4.js.map