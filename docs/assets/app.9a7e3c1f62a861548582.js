...
var BackToTopButton = function (_a) {
    ...
    var buttonStyle = setPosition(position, __assign(__assign({}, motionStyle), defaultStyle));
...
var fetchMiddleware = function (store) { return function (next) { return function (action) { return __awaiter(void 0, void 0, void 0, function () {
...
function default_1(state, action) {
    ...
    switch (action.type) {
        case REQUEST_FAKE_FETCH: {
            return __assign(__assign({}, state), { actionTime: currentTime, isFetching: true });
        }
        case RECEIVED_FAKE_FETCH: {
            var _a = action.payload, payload = _a === void 0 ? [] : _a;
            return __assign(__assign({}, state), { actionTime: currentTime, isFetching: false, data: __spreadArrays(payload) });
        }
        case ERROR_FAKE_FETCH: {
            var _b = action.error, error = _b === void 0 ? {} : _b;
            return __assign(__assign({}, state), { actionTime: currentTime, isFetching: false, error: __assign({}, error) });
        }
        default:
            return state;
    }
...
function default_1(state, action) {
    ...
    switch (action.type) {
        case CHECK_IF_USER_IS_AUTHENTICATED: {
            ...
            return __assign(__assign({}, state), { isAuthenticated: isAuthenticated,
                token: token, id: user.id, login: user.login, firstname: user.firstname, lastname: user.lastname });
        }
        case DISCONNECT_USER: {
            return __assign(__assign({}, state), { isAuthenticated: false, token: initialState.token, id: initialState.id, login: initialState.login, firstname: initialState.firstname, lastname: initialState.lastname });
        }
        case REQUEST_LOG_USER: {
            return __assign(__assign({}, state), { isLogging: true });
        }
        case RECEIVED_LOG_USER: {
            ...
            return __assign(__assign({}, state), { isAuthenticated: true, token: token, id: id, login: login, firstname: firstname, lastname: lastname, isLogging: false });
        }
        case ERROR_LOG_USER: {
            return __assign(__assign({}, state), { isAuthenticated: false, isLogging: false });
        }
        ...
        case RECEIVED_USER_INFOS_DATA: {
            ...
            return __assign(__assign({}, state), { isFetching: false, id: userInfos.id, login: userInfos.login, firstname: userInfos.firstname, lastname: userInfos.lastname });
        }
...
function checkUserIsConnected() {
    ...
    return __assign(__assign({ type: CHECK_IF_USER_IS_AUTHENTICATED, token: token }, user), { isAuthenticated: isAuthenticated && !isExpired });
}
...
/******/ });
//# sourceMappingURL=app.9a7e3c1f62a861548582.js.map